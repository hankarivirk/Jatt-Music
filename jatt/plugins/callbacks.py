...
from jatt import jatt, app, db, lang, queue, tg, yt
from jatt.helpers import admin_check, buttons, can_manage_vc
...
async def _controls(_, query: types.CallbackQuery):
    ...
    if action == "pause":
        ...
        return await jatt.play_media(chat_id, msg, media)
...
async def _settings_cb(_, query: types.CallbackQuery):
    ...
    if cmd[1] == "delete":
        ...
        _admin = not _admin
        await db.set_play_mode(chat_id, remove=not _admin)
